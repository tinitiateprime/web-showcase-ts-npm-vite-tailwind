  ...
  const InputField = ({
    ...
    return (
      <div className="relative group">
        ...
        {errors[name] && <p className="text-red-400 text-sm mt-2 ml-2 animate-pulse">{errors[name]}</p>}
      </div>
    );
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-50 animate-pulse" />
      </div>
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 w-full max-w-md shadow-2xl border border-white/20 relative z-10">
        ...
        {/* ✅ Form wrapper so handleSubmit is USED */}
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <InputField name="password" placeholder="Password" icon={Lock} showToggle />

          <InputField name="confirmPassword" placeholder="Confirm Password" icon={Lock} showToggle />
